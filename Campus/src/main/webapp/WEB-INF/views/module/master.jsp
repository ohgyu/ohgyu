...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-white-primary elevation-4">
    ...
    <a href="" class="brand-link">
      <img src="<%=request.getContextPath() %>/resources/bootstrap/dist/img/Camp_usLogo.png" alt="camp_us Logo" class="brand-image" style="opacity: .8">
      <span class="brand-text font-weight-light">Camp_us</span>
    </a>
